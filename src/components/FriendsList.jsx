...
const FriendsList = () => {
    ...
    const [friends, setFriends] = useState([
        {id: 1, name: 'Alice', url:'https://pngimg.com/uploads/snoopy/snoopy_PNG22.png'},
        {id: 2, name: 'Bob', url:'https://pngimg.com/uploads/snoopy/snoopy_PNG22.png'},
        {id: 3, name: 'Charlie', url:'https://pngimg.com/uploads/snoopy/snoopy_PNG22.png'},
        {id: 4, name: 'Suli' , url:'https://pngimg.com/uploads/snoopy/snoopy_PNG22.png'}
      ])
