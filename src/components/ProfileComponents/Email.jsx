    ...
    return (
        <div className="contactInfo">
            ...
            {user && username === user.user_metadata.username ?
                <>
                    <input type="text" name="profileEmailInput" id="profileEmailInput" className="profileInput noFocusHighlight" defaultValue={email} 
                    style={{border: '1px solid rgba(255, 255, 255, 0.4)', borderTop: 'none', borderLeft: 'none', borderRight: 'none'}} onInput={(e) => {
                        saveEmail(e)
                    }
                    }></input>
                </> : <>
                    <input readOnly type="text" name="profileEmailInput" id="profileEmailInput" className="profileInput noFocusHighlight" defaultValue={email}
